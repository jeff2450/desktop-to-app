        ...
        return (
          <div className="space-y-8 animate-in fade-in duration-300">
            <div>
              ...
              <p className="text-lg text-[#8d99c4] leading-relaxed">
            ...
            <section className="space-y-6">
              <div>
                <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-[#2b72f5]/10 flex items-center justify-center text-[#2b72f5]">
                    <Zap className="w-4 h-4" />
                  </div>
                  Quick Start Command
                </h2>
                <div className="bg-[#030720] border border-[#8d99c4]/15 rounded-2xl p-6 font-mono text-sm overflow-x-auto relative group">
                  <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                    <Button 
                      ...
                      variant="ghost" 
                      size="sm" 
                      className="h-8 w-8 p-0 hover:bg-[#020514] text-[#8d99c4]/60"
                    >
                      <Code className="w-4 h-4" />
                    </Button>
                  </div>
                  <div className="text-[#8d99c4]/50 mb-2"># In your existing web project root:</div>
                  <div className="flex gap-4">
                    <span className="text-[#8d99c4]/30">1</span>
                    <span className="text-[#2b72f5]">npx</span> <span className="text-white">webtoapp init</span>
                  </div>
                  <div className="flex gap-4">
                    <span className="text-[#8d99c4]/30">2</span>
                    <span className="text-[#2b72f5]">npx</span> <span className="text-white">webtoapp convert</span>
                  </div>
                  <div className="mt-4 text-[#8d99c4]/50"># Check system dependencies first:</div>
                  <div className="flex gap-4">
                    <span className="text-[#8d99c4]/30">3</span>
                    <span className="text-[#2b72f5]">npx</span> <span className="text-white">webtoapp doctor</span>
                  </div>
                </div>
              </div>

              <div className="bg-[#030720]/40 border border-[#8d99c4]/15 rounded-2xl p-6 flex gap-4 items-start">
                <div className="w-10 h-10 rounded-xl bg-[#fcc8b7]/10 flex items-center justify-center text-[#fcc8b7] flex-shrink-0">
                  <Cpu className="w-5 h-5" />
                </div>
                <div className="space-y-1">
                  <h4 className="font-bold text-white">System Toolchain Requirements</h4>
                  <p className="text-sm text-[#dee3f7]/70 leading-relaxed">
      ...
      case "how-it-works":
        return (
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="border border-[#8d99c4]/15 bg-[#030720]/20 rounded-2xl p-6 font-mono text-xs overflow-x-auto text-[#2b72f5]">
   ...
   Output: installer.exe / .dmg / .AppImage 🎉`}</pre>
            ...
            <div className="space-y-4">
              ...
              {[
                ...
                <div key={item.step} className="p-6 bg-[#030720]/30 border border-[#8d99c4]/15 rounded-xl flex gap-6 items-start hover:border-[#2b72f5]/30 transition-colors">
                  <div className="text-xl font-bold text-[#2b72f5] font-mono">{item.step}</div>
                  <div>
                    <h4 className="font-bold text-white mb-1">{item.name}</h4>
                    <p className="text-sm text-[#dee3f7]/70 leading-relaxed">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
...
└───────────────────────┬─────────────────────────────────┘
    ...
    └───────────────────┘`}</pre>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                <div key={idx} className="p-5 bg-[#030720]/30 border border-[#8d99c4]/15 rounded-xl hover:border-[#2b72f5]/20 transition-colors">
                  <h4 className="font-mono font-bold text-white mb-2 text-sm flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-[#2b72f5]"></span>
                    {item.name}
                  </h4>
                  <p className="text-xs text-[#dee3f7]/70 leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      case "config-json":
        return (
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="bg-[#020514] border border-[#8d99c4]/15 rounded-2xl p-6 font-mono text-sm overflow-x-auto text-[#dee3f7]/90">
              <pre>{`{
  "name": "My Desktop App",
  "version": "1.0.0",
  ...
  "database": { 
    "type": "sqlite" 
            ...
            <div className="overflow-x-auto border border-[#8d99c4]/15 rounded-2xl bg-[#030720]/10">
              <table className="w-full text-left border-collapse text-sm">
                <thead>
                  <tr className="border-b border-[#8d99c4]/15 text-[#8d99c4] font-semibold bg-[#030720]/40">
                ...
                <tbody className="divide-y divide-[#8d99c4]/10 text-[#dee3f7]/80">
                  {[
                    ...
                    <tr key={row.key} className="hover:bg-[#030720]/20">
                      <td className="p-4 font-mono font-semibold text-white">{row.key}</td>
                      <td className="p-4 font-mono text-[#2b72f5] text-xs">{row.type}</td>
                      <td className="p-4 text-xs font-semibold text-[#fcc8b7]">{row.req}</td>
                      <td className="p-4 font-mono text-[#8d99c4]/65 text-xs">{row.def}</td>
                      <td className="p-4 text-[#dee3f7]/70 text-xs leading-relaxed">{row.desc}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
      ...
      case "env-vars":
        return (
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="bg-[#020514] border border-[#8d99c4]/15 rounded-2xl p-6 font-mono text-sm overflow-x-auto text-[#dee3f7]/70">
...
SMTP_PASS=some_secure_password`}</pre>
            ...
            <div className="p-6 bg-[#fcc8b7]/5 border border-[#fcc8b7]/20 rounded-2xl">
              <h4 className="font-bold text-[#fcc8b7] mb-1 flex items-center gap-2">
          ...
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="space-y-4">
              ...
              {[
                ...
                <div key={item.flag} className="p-5 bg-[#030720]/30 border border-[#8d99c4]/15 rounded-xl hover:border-[#2b72f5]/30 transition-colors">
                  <span className="font-mono font-bold text-[#2b72f5] text-sm block mb-1">{item.flag}</span>
                  <p className="text-xs text-[#dee3f7]/70 leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>
          ...
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="p-5 bg-[#030720]/40 border border-[#8d99c4]/15 rounded-xl">
            ...
            <div className="bg-[#2b72f5]/5 border border-[#2b72f5]/20 rounded-2xl p-6">
              <h4 className="font-bold text-[#2b72f5] mb-2 flex items-center gap-2">
      ...
      case "ast-transform":
        return (
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-5 bg-[#030720]/30 border border-red-500/20 rounded-2xl">
                <div className="text-xs text-red-400 font-bold uppercase tracking-wider mb-2">Original Cloud Script</div>
                <pre className="font-mono text-xs text-[#8d99c4] leading-relaxed">
{`const { data, error } = await supabase
  ...
  .eq('status', 'confirmed');`}
              ...
              <div className="p-5 bg-[#030720]/30 border border-[#2b72f5]/30 rounded-2xl">
                <div className="text-xs text-[#2b72f5] font-bold uppercase tracking-wider mb-2">AST Transformed Script</div>
                <pre className="font-mono text-xs text-[#dee3f7] leading-relaxed">
{`const data = await window.desktopAPI
  .query('appointments', {
    where: { status: 'confirmed' }
            ...
            <div className="p-6 bg-[#030720]/50 border border-[#8d99c4]/15 rounded-2xl space-y-3">
          ...
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="p-5 bg-[#030720]/40 border border-[#8d99c4]/15 rounded-xl hover:border-[#2b72f5]/20 transition-colors">
                  <h4 className="font-bold text-white mb-2 text-sm">{item.title}</h4>
                  <p className="text-xs text-[#dee3f7]/65 leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      case "packaging":
        return (
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="p-6 bg-[#030720]/40 border border-[#8d99c4]/15 rounded-2xl flex gap-4 items-start">
              <div className="w-10 h-10 rounded-xl bg-[#2b72f5]/10 flex items-center justify-center text-[#2b72f5] flex-shrink-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="p-5 bg-[#030720]/30 border border-[#8d99c4]/15 rounded-xl">
                  <h4 className="font-bold text-white mb-1 text-sm">{item.title}</h4>
                  <span className="font-mono text-xs text-[#2b72f5] block mb-2">{item.ext}</span>
                  <p className="text-xs text-[#dee3f7]/70 leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>
  ...
  return (
    <div className="min-h-screen bg-[#020514] text-[#dee3f7]/80 font-sans selection:bg-[#2b72f5]/30">
      {/* ── Sidebar ── */}
      <aside className="fixed left-0 top-0 w-72 h-full border-r border-[#8d99c4]/10 bg-[#030720]/50 backdrop-blur-xl hidden lg:block p-8 overflow-y-auto">
        <Link href="/" className="flex items-center gap-2 mb-12 hover:opacity-80 transition-opacity">
          <div className="w-8 h-8 rounded-xl border border-[#2b72f5]/30 bg-[#2b72f5]/15 flex items-center justify-center font-bold text-white shadow-[0_0_15px_rgba(43,114,245,0.4)]">
            W
          </div>
        ...
        <div className="space-y-8">
          {filteredGroups.map((group, groupIdx) => (
            <section key={groupIdx}>
              <h4 className="text-xs font-bold uppercase tracking-widest text-[#8d99c4]/50 mb-4 px-2">
                {group.title}
              </h4>
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        active 
                          ? "bg-[#2b72f5]/15 text-[#2b72f5] font-semibold border-l-2 border-[#2b72f5] bg-[#2b72f5]/5" 
                          : "text-[#8d99c4] hover:text-white hover:bg-[#030720]/50"
                      )}
                    >
                      <Icon className={cn("w-4 h-4", active ? "text-[#2b72f5]" : "text-[#8d99c4]/65")} />
                      {item.title}
                    </button>
                  );
                })}
      ...
      <main className="lg:ml-72 min-h-screen flex flex-col">
        {/* Header */}
        <header className="sticky top-0 z-40 w-full border-b border-[#8d99c4]/10 bg-[#020514]/80 backdrop-blur-md px-8 h-16 flex items-center justify-between">
          <div className="flex-1 max-w-md relative">
            <Search className="w-4 h-4 text-[#8d99c4]/60 absolute left-3 top-1/2 -translate-y-1/2" />
            <Input 
              placeholder="Search documentation..." 
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="bg-[#030720]/50 border-[#8d99c4]/15 pl-10 h-9 rounded-lg text-sm focus:ring-[#2b72f5] text-white placeholder-[#8d99c4]/40"
            />
          </div>
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="sm" asChild className="text-[#8d99c4] hover:text-white">
              <Link href="https://github.com/jeff2450/desktop-to-app" target="_blank" className="flex items-center gap-2">
                GitHub <ExternalLink className="w-3 h-3" />
              </Link>
            </Button>
            <Button size="sm" asChild className="bg-[#2b72f5] hover:bg-[#1a5ecc] text-white rounded-lg px-4 font-medium transition-all">
        ...
        <div className="max-w-4xl px-8 py-12 pb-32 mx-auto w-full flex-1">
          {/* Breadcrumbs */}
          <div className="flex items-center gap-2 text-[10px] font-bold text-[#8d99c4]/60 mb-8 uppercase tracking-widest">
            <span>{currentItem.category}</span>
            <ChevronRight className="w-3 h-3 text-[#8d99c4]/40" />
            <span className="text-[#2b72f5]">{currentItem.title}</span>
          </div>
          ...
          {/* Footer Navigation */}
          <div className="mt-24 pt-12 border-t border-[#8d99c4]/10 flex justify-between items-center">
            {prevItem ? (
              <button 
                onClick={() => setActiveSection(prevItem.id)}
                className="group flex flex-col items-start gap-1 text-left"
              >
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#8d99c4]/50 group-hover:text-white">Previous</span>
                <span className="text-sm font-bold text-white group-hover:text-[#2b72f5] transition-colors">
                  {prevItem.title}
                </span>
              </button>
            ) : (
              <Link href="/" className="group flex flex-col items-start gap-1">
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#8d99c4]/50 group-hover:text-white">Previous</span>
                <span className="text-sm font-bold text-white group-hover:text-[#2b72f5] transition-colors">Home</span>
              </Link>
            )}
            ...
            {nextItem ? (
              ...
              >
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#8d99c4]/50 group-hover:text-white">Next</span>
                <span className="text-sm font-bold text-white group-hover:text-[#2b72f5] transition-colors flex items-center gap-1">
...
function DocCard({ icon: Icon, title, desc, onClick }: any) {
  return (
    <Card 
      onClick={onClick}
      className="bg-[#030720]/35 border-[#8d99c4]/15 hover:border-[#2b72f5]/50 hover:bg-[#030720]/50 transition-all group overflow-hidden cursor-pointer"
    >
      <CardContent className="p-6">
        <div className="w-10 h-10 rounded-xl bg-[#020514] border border-[#8d99c4]/10 flex items-center justify-center text-[#8d99c4] mb-4 group-hover:bg-[#2b72f5]/20 group-hover:text-[#2b72f5] transition-colors">
          <Icon className="w-5 h-5" />
        </div>
        <h3 className="font-bold text-white mb-2">{title}</h3>
        <p className="text-sm text-[#dee3f7]/70 leading-relaxed">{desc}</p>
      </CardContent>
    </Card>
  );
}
...
function ModeCard({ title, mode, desc, color, bg }: any) {
  return (
    <div className="bg-[#020514] border border-[#8d99c4]/15 p-6 rounded-2xl relative overflow-hidden group">
      ...
      <p className="text-xs text-[#dee3f7]/70 leading-relaxed">{desc}</p>
    </div>
  );
}
